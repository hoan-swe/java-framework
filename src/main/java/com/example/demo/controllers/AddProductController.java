...
import com.example.demo.validators.ValidProduct;
...
public class AddProductController {
    ...
    public String submitForm(@Valid @ModelAttribute("product")@ValidProduct Product product, BindingResult bindingResult, Model theModel) {
        theModel.addAttribute("product", product);
